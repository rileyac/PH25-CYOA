...
def hangman():
    print("Let's begin!")
    print("Rules:")
    print("1. You need to guess the letters of the missing word.")
    ...
    while attempts > 0:
        ...
        if "_" not in current_state:
            print("Congratulations! You guessed the missing word:", word)
            return 0

    print("Out of attempts! The missing word was:", word)
    return -1
